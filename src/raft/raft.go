...
func (rf *Raft) getPersistData() []byte {
	...
	DPrintf("Server %d persist data CurrentTerm %d, VoteFor %d, FirstUnsavedIndex %d, MaxLogIndex %d", rf.me, rf.CurrentTerm, rf.VoteFor, rf.FirstUnsavedIndex, rf.MaxLogIndex)
